...
// NewSubscriptionService creates a SubscriptionService configured with the given database,
// XUI client, configuration, and optional webhook sender.
// The webhookSender may be nil to disable webhook delivery.
=======
