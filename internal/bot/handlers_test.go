...
func TestNewHandler(t *testing.T) {
	...
	cfg := &config.Config{
		...
		Sources:          []config.Source{{Name: "main", XUIHost: "http://localhost:2053", XUIAPIToken: "test-api-token", XUIInboundIDs: "[1]"}},
	}
...
func TestHandler_ConfigField(t *testing.T) {
	...
	cfg := &config.Config{
		...
		Sources:          []config.Source{{Name: "main", XUIHost: "http://test.local:8080", XUIAPIToken: "test-api-token", XUIInboundIDs: "[1]"}},
	}
