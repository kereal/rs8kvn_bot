...
--   provider_fee_cents — комиссия провайдера, полученная best-effort из API
--     транзакций (GET /transaction/{id}). Поле NULL, пока провайдер не
--     ответил (или ответ недоступен).
